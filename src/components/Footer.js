        ...
        <div className="row">
          ...
          <div className="col-3">
            ...
            <div className='footer-links d-flex flex-column'>
              ...
              <Link className='text-white py-2 mb-l'>Shipping Policy</Link>
              <Link className='text-white py-2 mb-l'>Terms & Conditions</Link>
              <Link className='text-white py-2 mb-l'>Blogs</Link>
            </div>
          </div>
          <div className="col-3">
