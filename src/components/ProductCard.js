      ...
      <Link to=":id" className="product-card position-relative">
        ...
        <div className="product-details">
          ...
          <p className={`description ${grid === 12 ? 'd-block' : 'd-none'}`}>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis porro veniam necessitatibus vitae, incidunt ut quae possimus illo dicta maxime iste quod.
          </p>
        ...
        <div className="action-bar position-absolute">
          <div className="d-flex flex-column gap-15">
            ...
            <button className='border-0 bg-transparent'><img src={view} alt="viewcart" /></button>
